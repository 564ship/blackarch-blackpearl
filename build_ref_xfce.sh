...
#cat ./archiso-mktemplate/_onerous/calamares/packages-calamares-base.x86_64 >> ./archiso/packages_P.x86_64 ;
...
find ./out -name 'blackarch*.iso' |xargs -I{} sudo rename x86_64 x86_64-rel {} ;
sleep 3 ;
